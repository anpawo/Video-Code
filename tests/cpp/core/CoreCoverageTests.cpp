...
namespace VC
{
    ...
    {
        std::vector<std::string> argv = {"videocode", "--width", "800", "--height", "600", "--framerate", "30", "--file", "nonexistent.py", "--generate", "test.mp4", "--showstack", "true"};
    ...
    {
        std::vector<std::string> argv = {"videocode", "--width", "400", "--height", "300", "--framerate", "60", "--file", "test.py", "--generate", "test.mp4"};
        _parser.parse_args(argv);
    ...
    {
        std::vector<std::string> argv = {"videocode", "--width", "1280", "--height", "720", "--framerate", "24", "--file", "test.py", "--generate", "/tmp/coverage_test.mp4", "--showstack", "false"};
        _parser.parse_args(argv);
    ...
    {
        std::vector<std::string> argv = {"videocode", "--width", "640", "--height", "480", "--framerate", "30", "--file", "test.py", "--generate", "test.mp4"};
        _parser.parse_args(argv);
    ...
    {
        std::vector<std::string> argv = {"videocode", "--width", "800", "--height", "600", "--framerate", "30", "--file", "test.py", "--generate", "test.mp4", "--showstack", "true", "--time", "true"};
        _parser.parse_args(argv);
    ...
    TEST_F(CoreCoverageTests, WindowCoverage)
    {
        ...
        std::vector<std::string> argv = {"videocode", "--width", "400", "--height", "300", "--framerate", "30", "--file", "test.py", "--generate", "test.mp4"};
        _parser.parse_args(argv);
    ...
    {
        std::vector<std::string> argv = {"videocode", "--width", "640", "--height", "480", "--framerate", "24", "--file", "test.py", "--generate", "advanced_test.mp4", "--showstack", "true"};
        _parser.parse_args(argv);
