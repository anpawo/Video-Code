...
```json
{ "files": ["src/a.cpp", "src/b.cpp"], "reason": "why they stay two", "date": "2026-09-18" }
```

`files` takes globs. Inside a declared pair the script fails on GROWTH of the
...
```bash
python3 test/repetition_check.py --update
```
