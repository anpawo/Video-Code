...
Les trois carrés sont dans le monde : ils grossissent et glissent avec la
caméra. La légende en bas est `pinToFrame()` : elle est dans le CADRE, donc
elle garde sa taille et sa place — un sous-titre qui zoomerait avec l'image
deviendrait illisible.
"""

from videocode import *

Text(text="A2  ·  la caméra, et ce qu'on épingle au cadre", fontSize=0.34, fillColor=WHITE).position(0, 3.2)
