...
# ── 0→1 rate functions ──────────────────────────────────────────────────────
print("0->1 rate functions: endpoints")
...
print("there-and-back rate functions: start == end")
...
print("rangeIdx on a Func-based easing")
...
print("Input.rotateBy(easing=Easing.Wiggle) — wiggles out and back")
r = Rectangle()
...
print("Input.moveBy(easing=Easing.ThereAndBack) — moves out and back")
r2 = Rectangle()
