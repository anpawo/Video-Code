...
print("Rectangle — vertices, width/height, buildPoints fast path")
...
# ── Square ────────────────────────────────────────────────────────────────
print("Square — width == height == side")
sq = Square(side=3)
...
print("Triangle — vertices from p0/p1/p2, Polygon.width/height")
...
print("EquilateralTriangle — side-derived vertices")
import math
...
print("RightTriangle — width/height-derived vertices")
rt = RightTriangle(width=4, height=3)
check("vertices == [(0,0), (w,0), (0,h)]", rt.vertices == [(0, 0), (4, 0), (0, 3)])


# ── Circle ───────────────────────────────────────────────────────────────────
print("Circle — raw contour, single contour (no contourSizes)")
c = Circle(radius=1)
...
# ── Curve (open polygon) ─────────────────────────────────────────────────────
print("Curve — open path point count (2n for n input points)")
...
print("cornerRadius — prop change regenerates points and pushes Args:points")
...
print("width — prop change regenerates vertices and points")
...
print("sharpCorners — excluded vertex keeps a sharp corner despite cornerRadius")
...
# ── Polygon.contains ───────────────────────────────────────────────────────
print("Polygon.contains — point-in-polygon hit test")
