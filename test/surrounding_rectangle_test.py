...
section("SurroundingRectangle(Rectangle): default buff/color")
...
section("SurroundingRectangle(Circle): custom buff/color, scale copied")
...
# ── rotation copied ───────────────────────────────────────────────────────
section("SurroundingRectangle: rotation copied")
