...
print("Underline(Rectangle): default buff/color")
...
print("Underline(Rectangle): custom buff/color, scale copied")
...
print("Underline(Rectangle): rotation copied, offset rotated with shape")
